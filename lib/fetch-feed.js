/**
 * @module @rowanmanning/fetch-feed
 */
'use strict';
 ...
 */
module.exports = function fetchFeed({url, requestOptions, onInfo, onEntry} = defaultOptions) {
 ...
 * @param {FeedParser.Meta} feedInfo
 ...
 * @param {FeedParser.Item} feedEntry
